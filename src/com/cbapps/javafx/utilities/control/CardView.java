...
public class CardView extends Button {
	...
	private final StringProperty cardText = new SimpleStringProperty("Text");
	private final StringProperty cardTitle = new SimpleStringProperty("Title");
	private final ObjectProperty<Font> cardTextFont = new SimpleObjectProperty<>(RobotoFont.regular(14));
	private final ObjectProperty<Font> cardTitleFont = new SimpleObjectProperty<>(RobotoFont.medium(16));
